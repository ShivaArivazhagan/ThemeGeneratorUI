...
import GlobalImage from "./Image/global.png"
          ...
          <Router>
            <div className="item1">
              ...
              <div className='global'>
                <Link to="/About"> <img src={GlobalImage} alt="Global" style={{ "height": "40px" }} /> </Link>
              </div>
              <hr />
              <div className='Charts'>
                <Link to="/Contact"> <img src={img1} alt="Global" style={{ "height": "40px" }} /> </Link>
